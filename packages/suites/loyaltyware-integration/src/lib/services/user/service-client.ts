...
export const User = {
  async postScreenName() {
    ...
    return APIClient(authContext).getResponse<Record<string, any>>({
      ...
      data: {
        avatar:
          "https://cdn.sanity.io/images/c4naai3b/non-production/2ce32203f1fc0a43cb1108c4fc83491641a93f1f-400x400.png",
        screenName: "asdfasdfhh60089680",
        externalFacingId: "9ujOE5I4w4i1cpyesD78gO9SMgY78ZAYKuG22eXSmfM=2000078",
      },
